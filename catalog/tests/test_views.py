...
class AuthorListView(TestCase):
    ...
    def setUpTestData(cls):
        for id in range(13):
            Author.objects.create(first_name=f'{id} John', last_name='Doe')
...
class LoanedBooksByYserListView(TestCase):
    def setUp(self):
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_form_invalid_renewal_date_past(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertFormError(response.context['book_renewal_form'], "due_back", 'Invalid date - renewal in past')
    ...
    def test_form_invalid_renewal_date_future(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertFormError(response.context['book_renewal_form'], "due_back", 'Invalid date - renewal more than 4 weeks ahead')    